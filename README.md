...
**Method:** manual copy-paste, all 200 read and labeled by hand. No LLM pre-labeling — see [AI usage](#ai-usage) for why that was a deliberate refusal rather than an oversight.
